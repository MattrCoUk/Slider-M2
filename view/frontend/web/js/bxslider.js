...
(function() {
  ...
  jQuery(document).ready(function($) {
    ...
    $.fn.bxSlider = function(options) {
      var appendCaptions, appendControls, appendControlsAuto, appendPager, clickNextBind, clickPagerBind, clickPrevBind, clickStartBind, clickStopBind, el, getMoveBy, getNumberSlidesShowing, getPagerQty, getSlideWidth, getViewportHeight, getViewportMaxWidth, init, initAuto, initTicker, initTouch, loadElements, onTouchEnd, onTouchMove, onTouchStart, populatePager, resizeWindow, setPositionProperty, setSlidePosition, setup, slider, start, tickerLoop, updateAfterSlideTransition, updateAutoControls, updateDirectionControls, updatePagerActive, windowHeight, windowWidth;
      if (this.length === 0) {
        return this;
      }
...
// test for each property
      ...
      getViewportHeight = function() {
        var children, currentIndex, height, i;
        height = 0;
      ...
      getPagerQty = function() {
        var breakPoint, counter, pagerQty;
        pagerQty = 0;
      ...
      populatePager = function() {
        var i, linkContent, pagerHtml, pagerQty;
        pagerHtml = '';
      ...
      clickPagerBind = function(e) {
        var pagerIndex, pagerLink;
        // if auto show is running, stop it
        if (slider.settings.auto) {
          el.stopAuto();
        }
        pagerLink = $(e.currentTarget);
        if (pagerLink.attr('data-slide-index') !== void 0) {
      ...
      initTicker = function() {
        ...
        if (slider.settings.tickerHover && !slider.usingCSS) {
          ...
          slider.viewport.hover((function() {
            ...
            var newSpeed, property, ratio, totalDimens;
      ...
      tickerLoop = function(resumeSpeed) {
        var animateProperty, params, position, reset, resetValue, speed;
      ...
      onTouchMove = function(e) {
        var change;
        var change, orig, value, xMovement, yMovement;
        orig = e.originalEvent;
      ...
      resizeWindow = function(e) {
        var windowHeightNew, windowWidthNew;
      ...
      el.goToSlide = function(slideIndex, direction) {
        var lastChild;
        var eq, lastChild, lastShowingIndex, moveBy, position, requestEl, value;
